...
export class SalonsComponent implements OnInit {
  ...
  week: any[] = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
  ...
  getData() {
    ...
    this.api.post('v1/salon/salonDetails', { id: this.id, uid: uid }).then((data: any) => {
      this.apiCalled = true;
  ...
  getSalonsNearby() {
    ...
    this.api.post_private('v1/salon/getSalonsNearby', param).then((data: any) => {
      if (data && data.status == 200) {
